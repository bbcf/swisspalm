...
{
       0,     0,     3,     6,     7,     9,    12,    15,    17,    22,
      26,    28,    31,    33,    38,    40,    42,    44,    48,    50,
      54
};
...
{
      15,     0,    -1,    17,     6,    -1,    -1,    23,    -1,    23,
       4,    -1,    16,    18,    -1,    16,    -1,     7,    19,    20,
       8,    -1,     7,    19,     8,    -1,     5,    -1,    20,    21,
      -1,    21,    -1,     9,    22,    10,     3,    -1,     3,    -1,
       3,    -1,    25,    -1,    24,    11,    17,    -1,    17,    -1,
      12,    24,    13,    -1,    12,    24,    13,     3,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    64,    64,    67,    70,    72,    76,    87,    91,    92,
      96,   100,   101,   104,   108,   112,   114,   118,   126,   136,
     138
};
#endif
...
{
  "$end", "error", "$undefined", "TR_ID", "TR_DIST", "TR_NHX", "';'",
  "'['", "']'", "':'", "'='", "','", "'('", "')'", "$accept", "tree",
  "nh_cell", "nhx_cell", "nhx", "nhx_start", "key_val_list",
  "key_val_pair", "key", "node", "list", "inner", 0
};
#endif
...
{
       0,   256,   257,   258,   259,   260,    59,    91,    93,    58,
      61,    44,    40,    41
};
# endif
...
{
       3,    15,     0,     0,     7,     0,     4,    16,    18,     0,
       1,     0,     6,     2,     5,     0,    19,    10,     0,    17,
      20,     9,     0,     0,    12,    14,     0,     8,    11,     0,
      13
};
...
{
      -1,   -11,    -1,     6,     3,     1,     8,   -11,   -11,   -10,
     -11,     9,   -11,   -11,   -11,    -1,    12,   -11,    -4,   -11,
     -11,   -11,    13,     0,   -11,   -11,     7,   -11,   -11,    15,
     -11
};
...
{
       8,    15,     1,    16,    21,    22,    10,    13,    27,    22,
      11,     2,    14,    19,    17,    20,    25,    29,    30,     0,
      28
};

static const yytype_int8 yycheck[] =
{
       2,    11,     3,    13,     8,     9,     0,     6,     8,     9,
       7,    12,     4,    15,     5,     3,     3,    10,     3,    -1,
      23
};
...
{
       0,     3,    12,    15,    16,    17,    23,    25,    17,    24,
       0,     7,    18,     6,     4,    11,    13,     5,    19,    17,
       3,     8,     9,    20,    21,     3,    22,     8,    21,    10,
       3
};
...
#line 71 "parser.y"
  ...
  case 5:
#line 73 "parser.y"
    { (yyval) = (yyvsp[(1) - (2)]); (yyval)->d = (float)lastfnum; }
    break;
...
#line 109 "parser.y"
  ...
  case 15:
#line 113 "parser.y"
    { (yyval) = tr_new_node(); (yyval)->name = str_cpy(); }
    break;
...
#line 119 "parser.y"
    {
					(yyvsp[(1) - (3)])->node = (Tree**)realloc((yyvsp[(1) - (3)])->node, sizeof(Tree*) * ((yyvsp[(1) - (3)])->n + 1));
					(yyvsp[(1) - (3)])->node[(yyvsp[(1) - (3)])->n] = (yyvsp[(3) - (3)]);
					++((yyvsp[(1) - (3)])->n);
					(yyval) = (yyvsp[(1) - (3)]);
					(yyvsp[(3) - (3)])->pre = (yyval);
				}
...
#line 137 "parser.y"
  ...
  case 20:
#line 139 "parser.y"
    { (yyval) = (yyvsp[(2) - (4)]); (yyval)->name = str_cpy(); }
    break;
